...
module.exports.readCsvFile = async function (excelFilePath, template = null, templateType = 1) {
    ...
    for (let i = 2; i < roundsRest; i++) {
        rowsToInsert.push({
            ...
            documentDate: documentDateIndex > 0 ? chrono.de.parseDate(sheet.getRow(i).getCell(documentDateIndex).value) : null,
            ...
            applicationDate: applicationDateIndex > 0 ? chrono.de.parseDate(sheet.getRow(i).getCell(applicationDateIndex).value) : null,
            postingDate: postingDateIndex > 0 ? chrono.de.parseDate(sheet.getRow(i).getCell(postingDateIndex).value) : null,
            ...
            dueDate: dueDateIndex > 0 ? chrono.de.parseDate(sheet.getRow(i).getCell(dueDateIndex).value) : null,
